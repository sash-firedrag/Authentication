...
export default function Home() {
  ...
  useEffect(() => {
    axios.get('https://authentication-e2yy.onrender.com/api/auth/me', { withCredentials: true })
      .then(r => setU(r.data.user))
      .catch(() => setU(null));
  }, []);

  const lg = async () => {
    await axios.post('https://authentication-e2yy.onrender.com/api/auth/logout', {}, { withCredentials: true });
    setU(null);
  };
